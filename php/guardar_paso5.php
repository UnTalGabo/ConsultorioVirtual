...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header("Location: ../paso5.php?id=" . $_POST['id_paciente']);
    exit();
}
...
$sql_check = "SELECT id FROM antecedentes_gineco_obstetricos WHERE id_paciente = ?";
...
if ($result->num_rows > 0) {
    ...
    $stmt->bind_param(
        "iiisiiiissi", 
        $id_paciente, $edad_inicio_regla, $ritmo_ciclo_menstrual, 
